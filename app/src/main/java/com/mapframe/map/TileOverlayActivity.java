 ...
 * <p/>
 */
public class TileOverlayActivity extends Activity implements BaiduMap.OnMapLoadedCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = findViewById(R.id.online_url);
        hidePoiInfo = findViewById(R.id.hide_poiinfo);
        // 设置在线方法监听
